...
public class MyGChain<G> extends GChain<G> {
      int count;
      Object[] element;
      ...
      public MyGChain<G> union(MyGChain<G> chain) {
            MyGChain<G> union = new MyGChain<G>();
            for (int i = 0; i < this.size; i++) {
      ...
      public MyGChain<G> intersection(MyGChain<G> chain) {
            MyGChain<G> intersection = new MyGChain<G>();
            for (int i = 0; i < this.size; i++) {
      ...
      public static void main(String[] args) {
            ...
            MyGChain<Object> my = new MyGChain<Object>();
            MyGChain<Object> list;
                        ...
                        case 3: {
                              ...
                              while (true) {
                                    ...
                                    if (index < count)
                                          ...
                                          System.out
                                                      .println("Element with provided index not found. Please enter a correct index!!!");
                              }
